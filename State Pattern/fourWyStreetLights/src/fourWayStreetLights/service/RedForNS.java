...
public class RedForNS implements StreetLightsStateI {
	
	StreetLightsContext streetlightscontext;

	/**
	 * parameterized constructor for RedForNS class
	 * @param streetLightsContext
	 */
	public RedForNS(StreetLightsContext streetLightsContext) {
	...
	public void turnEWRed() {
		System.out.println("Stop cars from moving in East or West");
	...
	public void turnEWGreen() {
		System.out.println("Signal is already green in East and West direction");
	...
	public void turnNSRed() {
		System.out.println("Signal is already Red in North adn South direction");
	...
	public void turnNSGreen() {
		System.out.println("Let cars move in North and South direction");
